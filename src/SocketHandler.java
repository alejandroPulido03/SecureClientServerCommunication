...
public class SocketHandler extends Thread {
    ...
    private static final BigInteger P = new BigInteger("", 16);
    ...
    private void openCommunicationProtocol() throws IOException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        ...
        this.dataInputStream.readUTF();
            byte[] challenge = this.dataInputStream.readAllBytes();
    ...
    // CALC LAS LLAVES FIN PARTE 1
            ...
            String usuario = new String(CryptoUtils.descifrarSimetrico(K_AB1, userEncrypted));
            String contra = new String(CryptoUtils.descifrarSimetrico(K_AB1, passwordEncrypted));
            ...
            String consulta = new String(CryptoUtils.descifrarSimetrico(K_AB1, consultaEncrypted));
    ...
    private void shareDiffieHellmanValues() throws IOException, InvalidKeyException, NoSuchAlgorithmException, SignatureException {
